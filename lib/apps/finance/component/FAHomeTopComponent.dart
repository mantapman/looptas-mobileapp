          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Text("\$ 1000",
                      style: boldTextStyle(color: Colors.white, size: 60)),
                  8.width,
                  Icon(Icons.info_outline_rounded, color: Colors.white70),
                ],
              ),
              8.height,
              Text('Uky Yanuhandoko S.Kom',
          ...
          child: Container(
            ...
            child: Align(
              ...
              child: Row(
                ...
                children: [
                  homeWidget(icon: fa_top_up, title: "Deposit").onTap(() {
                    toast('click');
                  }),
                  homeWidget(icon: fa_transfer, title: "Returned").onTap(() {
                    FASendMoneyScreen().launch(context);
                  }),
                  homeWidget(icon: fa_history, title: "Reuses").onTap(() {
                    toast('click');
                  }),
                  homeWidget(icon: fa_atm, title: "Get Paid").onTap(() {
                    toast('click');
                  }),
                ],
              ),
